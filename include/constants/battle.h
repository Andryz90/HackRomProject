...
// Battle environment defines for gBattleEnvironment. (From expansion)
...
// Battle terrain defines for gBattleTerrain. (Custom used)
...
#define FORMATION_OFF         0
#define FORMATION_IN_PROGRESS 1
#define FORMATION_STARTED     2
