...
#define TRAINER_MAGMA_GRUNT_ROUTE114        628
...
enum Opponents_Additional_Trainer_enum
{
    START_OPP_ADDITIONAL_TRAINER = START_ADDITIONAL_TRAINER_FLAGS,
    TRAINER_MAGMA_GRUNT_DESERT_SPINNER1,
...
// #define TRAINER_DAWSON_2                     (START_ADDITIONAL_TRAINER_FLAGS + 5)
...
#define TRAINERS_FLAGS_SIZE                 ((TRAINERS_COUNT + 7) / 8)
