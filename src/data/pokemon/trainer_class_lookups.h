const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_BUGSY] = TRAINER_PIC_LEADER_BUGSY,
    [FACILITY_CLASS_SPLITFACE] = TRAINER_PIC_SPLITFACE,
};
...
const u16 gFacilityClassToTrainerClass[] =
{
    ...
    [FACILITY_CLASS_BUGSY] = TRAINER_CLASS_LEADER,
    [FACILITY_CLASS_SPLITFACE] = TRAINER_CLASS_SPLITFACE,
};
