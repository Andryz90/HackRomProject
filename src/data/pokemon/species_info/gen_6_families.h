...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_BULLETPROOF, ABILITY_ROUGH_SKIN },
    ...
    [SPECIES_BUNNELBY] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ADAPTABILITY, ABILITY_CHEEK_POUCH, ABILITY_HUGE_POWER },
...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
        ...
        .abilities = { ABILITY_FLOWER_VEIL, ABILITY_AROMA_VEIL, ABILITY_MISTY_PELT },  \
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_ESPURR] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_MEOWSTIC_MALE, CONDITIONS({IF_GENDER, MON_MALE})},
                                {EVO_LEVEL, 25, SPECIES_MEOWSTIC_FEMALE, CONDITIONS({IF_GENDER, MON_FEMALE})}),
    },
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_SPRITZEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY),
        .abilities = { ABILITY_HEALER, ABILITY_MISTY_SURGE, ABILITY_AROMA_VEIL },
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_SLIGGOO},
                                {EVO_ITEM, ITEM_HISUIAN_AMULET, SPECIES_SLIGGOO_HISUI}),
    },
    ...
    [SPECIES_GOODRA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SAP_SIPPER, ABILITY_HYDRATION, ABILITY_POISON_HEAL },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_BERGMITE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_AVALUGG},
                                {EVO_ITEM, ITEM_HISUIAN_AMULET, SPECIES_AVALUGG_HISUI}),
    },
