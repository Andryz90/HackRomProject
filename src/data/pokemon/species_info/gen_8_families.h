...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_BLIPBUG] =
    {
        ...
        .abilities = { ABILITY_PRISM_ARMOR, ABILITY_COMPOUND_EYES, ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_ORBEETLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_PRISM_ARMOR, ABILITY_MAGIC_GUARD, ABILITY_TELEPATHY },
    ...
    [SPECIES_YAMPER] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BALL_FETCH, ABILITY_ELECTRIC_PELT, ABILITY_RATTLED },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_BOLTUND] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STRONG_JAW, ABILITY_ELECTRIC_PELT, ABILITY_COMPETITIVE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_SILICOBRA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_SANDACONDA}),
    },
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color)                                      \
    ...
    [SPECIES_FALINKS] =
    {
        ...
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_DEFIANT,  ABILITY_FORMATION},
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_STONJOURNER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_POWER_SPOT, ABILITY_STURDY, ABILITY_SOLID_ROCK },
        .bodyColor = BODY_COLOR_GRAY,
