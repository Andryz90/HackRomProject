...
const u16 gTrainerPalette_LeaderBugsy[] = INCBIN_U16("graphics/trainers/front_pics/leader_bugsy.gbapal");

//Splitface frontpic
const u32 gTrainerFrontPic_Splitface[] = INCBIN_U32("graphics/trainers/front_pics/Splitface_front.4bpp.lz");
const u16 gTrainerPalette_Splitface[] = INCBIN_U16("graphics/trainers/front_pics/Splitface_front.gbapal");

//Andry frontpic
const u32 gTrainerFrontPic_Andry[] = INCBIN_U32("graphics/trainers/front_pics/Andry_front_pic.4bpp.lz");
const u16 gTrainerPalette_Andry[] = INCBIN_U16("graphics/trainers/front_pics/Andry_front_pic.gbapal");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_LEADER_BUGSY, gTrainerFrontPic_LeaderBugsy, gTrainerPalette_LeaderBugsy),
    TRAINER_SPRITE(TRAINER_PIC_SPLITFACE, gTrainerFrontPic_Splitface, gTrainerPalette_Splitface),
    TRAINER_SPRITE(TRAINER_PIC_ANDRY, gTrainerFrontPic_Andry, gTrainerPalette_Andry),
};
