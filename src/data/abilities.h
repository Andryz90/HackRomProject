const struct Ability gAbilitiesInfo[ABILITIES_COUNT] =
{
    ...
    {
        .name = _("Illuminate"),
        .description = COMPOUND_STRING("Lower acc of not electr type."),
        .aiRating = 0,
        .breakable = TRUE,
    },
    ...
    {
        .name = _("Leaf Guard"),
        .description = COMPOUND_STRING("Blocks status in sunshine, boost grass."),
        .aiRating = 2,
        .breakable = TRUE,
    },
    ...
    [ABILITY_WATER_COMPACTION] =
    {
        ...
        .description = COMPOUND_STRING("Water Immune and boosts Defense."),
        .aiRating = 4,
    },
