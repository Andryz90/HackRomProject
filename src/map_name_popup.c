...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_ALTERNATIVE_FOREST] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_GAME_CORNER - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_POKEMON_DAY_CARE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_ALTERNATIVE_FOREST] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_GAME_CORNER - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_POKEMON_DAY_CARE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_BW_DEFAULT,
};
