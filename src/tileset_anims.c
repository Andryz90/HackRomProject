...
const u16 gTilesetAnims_Area_Zero_Frame0[] = INCBIN_U16("data/tilesets/secondary/area_zero/0.4bpp");
const u16 gTilesetAnims_Area_Zero_Frame1[] = INCBIN_U16("data/tilesets/secondary/area_zero/1.4bpp");
