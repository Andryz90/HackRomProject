...
extern const u8 Move_COMBO_PUNCH[];
extern const u8 Move_POISON_DRAIN[];
extern const u8 Move_Deterio[];
extern const u8 Move_SNOW_SLIDE[];
extern const u8 Move_POISON_DRILL[];
extern const u8 Move_TECTONIC_POWER[];
extern const u8 Move_ROYAL_GUARD[];
extern const u8 Move_PIXIE_DRAIN[];
extern const u8 Move_WATER_FANGS[];
extern const u8 Move_SISMA[];
extern const u8 Move_HOARFROST[];
extern const u8 Move_PURIFYING_WATER[];
extern const u8 Move_WINDSOM_OF_CHANGE[];
extern const u8 Move_SEASON_POWER[];
extern const u8 Move_PIXIE_FANGS[];
extern const u8 Move_IRON_GRIP[];
