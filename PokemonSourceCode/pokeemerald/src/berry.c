...
const struct Berry gBerries[] =
{
    [ITEM_CHERI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .size = 20,
        .maxYield = YIELD_RATE(3, 5, 15, 30),
        .minYield = YIELD_RATE(2, 2, 4, 10),
    ...
    [ITEM_LEPPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_RED,
        .size = 28,
        .maxYield = YIELD_RATE(3, 5, 15, 5),
        .minYield = YIELD_RATE(2, 2, 2, 1),
    ...
    [ITEM_LUM_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_GREEN,
        .size = 34,
        .maxYield = YIELD_RATE(2, 5, 20, 30),
        .minYield = YIELD_RATE(1, 2, 3, 10),
    ...
    [ITEM_SITRUS_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .color = BERRY_COLOR_YELLOW,
        .size = 95,
        .maxYield = YIELD_RATE(3, 5, 20, 40),
        .minYield = YIELD_RATE(2, 2, 3, 15),
...
static u8 CalcBerryYieldInternal(u16 max, u16 min, u8 water)
{
    ...
    if (water == 0 || OW_BERRY_MOISTURE) // Plants already grown without any water
    {
