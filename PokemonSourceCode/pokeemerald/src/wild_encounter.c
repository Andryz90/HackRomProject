...
static u8 ChooseWildMonIndex_Fishing(u8 rod)
{
    ...
    case OLD_ROD:
        if (rand < ENCOUNTER_CHANCE_FISHING_MONS_OLD_ROD_SLOT_0)
            wildMonIndex = 0;
        if (ENCOUNTER_CHANCE_FISHING_MONS_OLD_ROD_SLOT_0 < rand < ENCOUNTER_CHANCE_FISHING_MONS_OLD_ROD_SLOT_1)
            wildMonIndex = 1;
        ...
        if (rand >= ENCOUNTER_CHANCE_FISHING_MONS_OLD_ROD_SLOT_2 && rand < ENCOUNTER_CHANCE_FISHING_MONS_OLD_ROD_SLOT_3)
            wildMonIndex = 3;
        if (ENCOUNTER_CHANCE_FISHING_MONS_OLD_ROD_SLOT_3 < rand < ENCOUNTER_CHANCE_FISHING_MONS_OLD_ROD_SLOT_4)
            wildMonIndex = 4;
