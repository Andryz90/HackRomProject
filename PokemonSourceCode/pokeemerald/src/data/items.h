...
const struct Item gItemsInfo[] =
    {
        ...
        [ITEM_TM_DRAGON_CHEER] =
            {
                ...
                .price = 2000,
                .description = COMPOUND_STRING(
                    "The user raises allies\n"
                    "morale, boosting\n"
                    "critical hits. Doubled if Dragon."),
                .importance = I_REUSABLE_TMS,
                .pocket = POCKET_TM_HM,
                .type = ITEM_USE_PARTY_MENU,
                .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        ...
        [ITEM_TM_IRON_HEAD] =
            {
                ...
                .price = 3000,
                .description = COMPOUND_STRING(
                    "User slam target with\n"
                    "with steel-hard head.1n"
                    "May fliches target."),
                .importance = I_REUSABLE_TMS,
                .pocket = POCKET_TM_HM,
                .type = ITEM_USE_PARTY_MENU,
        ...
        [ITEM_TM_FOCUS_BLAST] = {
            ...
            .name = _("TM63"), .price = 3000,
            .description = COMPOUND_STRING("The user heightens\n"
                                           "its mental focus\n"
                                           "and unleashes its\n"
                                           "power. It may also\n"
                                           "lower the target's\n"
        ...
        [ITEM_TM_GRASS_KNOT] = {
            ...
            .name = _("TM64"), .price = 3000,
            .description = COMPOUND_STRING("The user snares\n"
                                           "the foe with grass\n"
                                           "and trips it. The\n"
                                           "heavier the foe,\n"
                                           "the greater the\n"
        ...
        [ITEM_TM_BUG_BUZZ] = {
            ...
            .name = _("TM65"), .price = 3000,
            .description = COMPOUND_STRING("The user vibrates\n"
                                           "its wings to\n"
                                           "generate a\n"
                                           "damaging sound\n"
                                           "wave. It may also\n"
        ...
        [ITEM_TM_STEEL_BEAM] = {
            ...
            .name = _("TM66"), .price = 3000,
            .description = COMPOUND_STRING("The user fires a\n"
                                           "beam of steel that\n"
                                           "it collected from\n"
                                           "its entire body.\n"
                                           "This also damages\n"
        ...
        [ITEM_TM_ELECTROWEB] = {
            ...
            .name = _("TM70"), .price = 3000,
            .description = COMPOUND_STRING("The user attacks\n"
                                           "and captures\n"
                                           "opposing Pokémon\n"
                                           "using an electric\n"
                                           "net. This lowers\n"
                                           "their Speed stat."), // Todo
            .importance = I_REUSABLE_TMS,
            .pocket = POCKET_TM_HM,
            .type = ITEM_USE_PARTY_MENU,
            .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        ...
        [ITEM_TM_TRIPLE_AXEL] = {
            ...
            .name = _("TM71"), .price = 3000,
            .description = COMPOUND_STRING("A consecutive\n"
                                           "three-kick attack\n"
                                           "that becomes more\n"
                                           "powerful with each\n"
                                           "successful hit."), // Todo
        ...
        [ITEM_TM_SLUDGE_WAVE] = {
            ...
            .name = _("TM72"), .price = 3000,
            .description = COMPOUND_STRING("It swamps the area\n"
                                           "around the user\n"
                                           "with a giant\n"
                                           "sludge wave. It\n"
                                           "may also poison\n"
        ...
        [ITEM_TM_SCORCHING_SANDS] = {
            ...
            .name = _("TM73"), .price = 3000,
            .description = COMPOUND_STRING("The user throws\n"
                                           "scorching sand at\n"
                                           "the target to\n"
                                           "attack. This may\n"
                                           "also leave the\n"
                                           "target with a burn"), // Todo
            .importance = I_REUSABLE_TMS,
            .pocket = POCKET_TM_HM,
            .type = ITEM_USE_PARTY_MENU,
            .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        ...
        [ITEM_TM_COACHING] = {
            ...
            .name = _("TM76"), .price = 3000,
            .description = COMPOUND_STRING("The user properly\n"
                                           "coaches its ally\n"
                                           "Pokémon, boosting\n"
                                           "their Attack and\n"
                                           "Defense stats."), // Todo
        ...
        [ITEM_TM_TEMPER_FLARE] = {
            ...
            .type = ITEM_USE_PARTY_MENU,
            .fieldUseFunc = ItemUseOutOfBattle_TMHM,
            .secondaryId = MOVE_TEMPER_FLARE, // Todo
        },
        [ITEM_TM_DUAL_WINGBEAT] = {

            .name = _("TM78"), .price = 3000,
        ...
        [ITEM_TM_CLOSE_COMBAT] = {
            ...
            .name = _("TM83"), .price = 3000,
            .description = COMPOUND_STRING("The user fights\n"
                                           "the foe in close\n"
                                           "without guarding\n"
                                           "itself. It also\n"
                                           "cuts the user's\n"
        ...
        [ITEM_TM_CRUNCH] = {
            ...
            .name = _("TM84"), .price = 3000,
            .description = COMPOUND_STRING("Crunches with\n"
                                           "sharp fangs. May\n"
                                           "lower Sp. Def."), // Todo
            .importance = I_REUSABLE_TMS,
            .pocket = POCKET_TM_HM,
        ...
        [ITEM_TM_SNARL] = {
            ...
            .name = _("TM86"), .price = 3000,
            .description = COMPOUND_STRING("The user yells as\n"
                                           "if it is ranting\n"
                                           "about something,\n"
                                           "making the\n"
                                           "target's Sp. Atk\n"
        ...
        [ITEM_TM_DISARMING_VOICE] = {
            ...
            .name = _("TM87"), .price = 3000,
            .description = COMPOUND_STRING("Letting out a\n"
                                           "charming cry, the\n"
                                           "user does\n"
                                           "emotional damage\n"
                                           "to opposing\n"
        ...
        [ITEM_TM_DRAINING_KISS] = {
            ...
            .name = _("TM88"), .price = 3000,
            .description = COMPOUND_STRING("The user steals\n"
                                           "the target's\n"
                                           "energy with a\n"
                                           "kiss. The user's\n"
                                           "HP is restored by\n"
        ...
        [ITEM_TM_WORK_UP] = {
            ...
            .name = _("TM89"), .price = 3000,
            .description = COMPOUND_STRING("The user is\n"
                                           "roused, and its\n"
                                           "Attack and Sp. Atk\n"
                                           "stats increase."), // Todo
            .importance = I_REUSABLE_TMS,
        ...
        [ITEM_TM_AGILITY] = {
            ...
            .name = _("TM92"), .price = 3000,
            .description = COMPOUND_STRING("Sharply increases\n"
                                           "the user's Speed."), // Todo
            .importance = I_REUSABLE_TMS,
            .pocket = POCKET_TM_HM,
            .type = ITEM_USE_PARTY_MENU,
            .fieldUseFunc = ItemUseOutOfBattle_TMHM,
        ...
        [ITEM_TM_CHARM] = {
            ...
            .name = _("TM93"), .price = 3000,
            .description = COMPOUND_STRING("Charms the foe and\n"
                                           "sharply reduces\n"
                                           "its Attack."), // Todo
            .importance = I_REUSABLE_TMS,
            .pocket = POCKET_TM_HM,
        ...
        [ITEM_TM_U_TURN] = {
            ...
            .name = _("TM99"), .price = 3000,
            .description = COMPOUND_STRING("After making its\n"
                                           "attack, the user\n"
                                           "rushes back to\n"
                                           "switch places with\n"
                                           "a party Pokémon in\n"
    ...
    [ITEM_POKE_VIAL] =
    {
        ...
        .price = 0,
        .holdEffectParam = 0,
        .description = COMPOUND_STRING("Potent medicine\n"
                                       "that fully restores\n"
                                       "all Pokémon."),
        .importance = 1,
        .pocket = POCKET_KEY_ITEMS,
