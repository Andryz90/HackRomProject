...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DARTRIX] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_DECIDUEYE},
                                {EVO_ITEM_HOLD, ITEM_HISUIAN_AMULET, SPECIES_DECIDUEYE_HISUIAN}),
    },
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_OWN_TEMPO, ABILITY_VITAL_SPIRIT, ABILITY_STEADFAST },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 24, SPECIES_LYCANROC_MIDDAY},
                                {EVO_LEVEL_NIGHT, 24, SPECIES_LYCANROC_MIDNIGHT},
                                {EVO_LEVEL_DUSK, 24, SPECIES_LYCANROC_DUSK}), //controllare
    },
    ...
    [SPECIES_ROCKRUFF_OWN_TEMPO] =
    {
        ...
        .eggMoveLearnset = sRockruffEggMoveLearnset,
        .formSpeciesIdTable = sRockruffFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL_DUSK, 24, SPECIES_LYCANROC_DUSK}),
    },
    ...
    [SPECIES_LYCANROC_MIDDAY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SAND_RUSH, ABILITY_SAND_RUSH, ABILITY_STRONG_JAW },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_LYCANROC_MIDNIGHT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_VITAL_SPIRIT, ABILITY_VITAL_SPIRIT, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Lycanroc"),
    ...
    [SPECIES_STEENEE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_OBLIVIOUS, ABILITY_IRON_KICK },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_TSAREENA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_LEAF_GUARD, ABILITY_QUEENLY_MAJESTY, ABILITY_IRON_KICK },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_ORANGURU] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_TELEPATHY, ABILITY_PSYCHIC_PELT },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_GOLISOPOD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG, EGG_GROUP_WATER_3),
        .abilities = { ABILITY_EMERGENCY_EXIT, ABILITY_NONE, ABILITY_STAMINA },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 37, SPECIES_PALOSSAND}),
    },
