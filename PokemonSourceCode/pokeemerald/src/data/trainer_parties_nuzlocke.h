...
static const struct TrainerMon sParty_Tiana[] = {
    ...
    .moves = {MOVE_CHARM, MOVE_TACKLE, MOVE_ATTRACT, MOVE_DISARMING_VOICE}
    ...
    .lvl = 6,
    .species = SPECIES_SKITTY,
    .moves = {MOVE_FAKE_OUT, MOVE_TACKLE, MOVE_ATTRACT, MOVE_TAIL_WHIP}
    },
    {
    .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
    .lvl = 6,
    .species = SPECIES_SNUBBULL,
    .moves = {MOVE_CHARM, MOVE_ROCK_SMASH, MOVE_COVET, MOVE_ATTRACT}
    }
};
